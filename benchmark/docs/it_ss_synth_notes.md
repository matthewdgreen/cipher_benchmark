        # Italian Synthetic Cipher Benchmark — Notes
...
- Le avventure di Pinocchio — Carlo Collodi
        ...
        ### Tier 1 — Word boundaries preserved (`it_ss_synth`)
        Split file: `splits/it_ss_synth_tests.jsonl`
        - 30 tests, IDs `it_ss_synth_001` … `it_ss_synth_030`
        - Ciphertext: single cipher letters separated by spaces,
          words delimited by ` | `.

        ### Tier 2 — No word boundaries (`it_ss_synth_nb`)
        Split file: `splits/it_ss_synth_nb_tests.jsonl`
        - 30 tests, IDs `it_ss_synth_nb_001` … `it_ss_synth_nb_030`
