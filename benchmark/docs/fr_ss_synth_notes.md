        # French Synthetic Cipher Benchmark — Notes
...
- Madame Bovary — Gustave Flaubert
        ...
        ### Tier 1 — Word boundaries preserved (`fr_ss_synth`)
        Split file: `splits/fr_ss_synth_tests.jsonl`
        - 30 tests, IDs `fr_ss_synth_001` … `fr_ss_synth_030`
        - Ciphertext: single cipher letters separated by spaces,
          words delimited by ` | `.

        ### Tier 2 — No word boundaries (`fr_ss_synth_nb`)
        Split file: `splits/fr_ss_synth_nb_tests.jsonl`
        - 30 tests, IDs `fr_ss_synth_nb_001` … `fr_ss_synth_nb_030`
